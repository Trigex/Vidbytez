...
function showstars(stars) {
    ...
    for (x = 0; x < stars; x++) {
        i++;
        document.getElementById(i).src = 'https://i.r.worldssl.net/img/full_star.gif'
    }
}
function removestars(stars) {
    ...
    for (x = 0; x < stars; x++) {
        i++;
        document.getElementById(i).src = 'https://i.r.worldssl.net/img/no_star.gif'
    }
}
function commentf() {
...
function lv_on_complete(e) {
    if (e.target.responseText !== "") {
        _("st_em").value = "https://www.vidlii.com/watch?v=" + e.target.responseText
    } else {
...
function post_bulletin() {
    ...
    if ((bulletin.length > 0 && bulletin.length < 501) || (bulletin2.length > 0 && bulletin2.length < 501)) {
        ...
        if (bulletin.length > 0) {
            ...
            _("ra_in").innerHTML = '<tr><td valign="top" width="18.5"><img src="https://i.r.worldssl.net/img/ra1.png"></td><td><strong>' + username + '</strong> ' + bulletin + ' <span>(1 second ago)</span></td> </tr>' + _("ra_in").innerHTML
        } else {
            if (_("no_ra2")) {
                _("no_ra2").outerHTML = ""
            }
            _("ra_in2").innerHTML = '<tr><td valign="top" width="18.5"><img src="https://i.r.worldssl.net/img/ra1.png"></td><td><strong>' + username + '</strong> ' + bulletin + ' <span>(1 second ago)</span></td> </tr>' + _("ra_in").innerHTML
        }
    } else {
...
function fpreview() {
    ...
    _('f_demo').src = "https://i.r.worldssl.net/img/filters/filter" + num + ".jpg"
}
...
function wn(type) {
    if (type == "w_sh") {
        $("#w_sh").attr("src", "https://i.r.worldssl.net/img/shhd1.png")
    } else if (type == "w_fv") {
        $("#w_fv").attr("src", "https://i.r.worldssl.net/img/hehd1.png")
    } else if (type == "w_pl") {
        $("#w_pl").attr("src", "https://i.r.worldssl.net/img/plhd1.png")
    } else if (type == "w_fl") {
        $("#w_fl").attr("src", "https://i.r.worldssl.net/img/flhd1.png")
    }
}
function wl(type) {
    if (type == "w_sh" && current_page !== 0) {
        $("#w_sh").attr("src", "https://i.r.worldssl.net/img/shhd0.png")
    } else if (type == "w_fv" && current_page !== 1) {
        $("#w_fv").attr("src", "https://i.r.worldssl.net/img/hehd0.png")
    } else if (type == "w_pl" && current_page !== 2) {
        $("#w_pl").attr("src", "https://i.r.worldssl.net/img/plhd0.png")
    } else if (type == "w_fl" && current_page !== 3) {
        $("#w_fl").attr("src", "https://i.r.worldssl.net/img/flhd0.png")
    }
}
function wc(type) {
    if (type == "w_sh" && current_page !== 0) {
...
$(".u_sct").click(function() {
    if ($(this).next().css("display") == "block") {
        ...
        $(this).children('img').first().attr("src", "https://i.r.worldssl.net/img/clp00.png")
    } else {
        $(this).next().css("display", "block");
        $(this).children('img').first().attr("src", "https://i.r.worldssl.net/img/clp11.png")
    }
});
function textCounter(e, s, n) {
    var t = document.getElementById(s);
    return e.value.length > n ? (e.value = e.value.substring(0, n),
    !1) : void (t.innerHTML = e.value.length)
}
function show_reply(id, is_owner, reply_to) {
    if ($("#wtr_" + id).length == 0) {
        ...
        if (reply_to)
            $("#r_cmt_" + id).find("textarea").val("@" + reply_to + " ").focus()
    } else {
        $("#r_cmt_" + id).html('')
    }
}
...
function wr(comment, type, thumps) {
    if (type == 1) {
        ...
        $(thumps).attr("src", "https://i.r.worldssl.net/img/tu1.png");
        $(thumps).prev().css("opacity", "");
        var Number = $(thumps).prev().prev().text();
        if ($(thumps).prev().attr("src") == "https://i.r.worldssl.net/img/td1.png") {
            Number++;
            Number++
        } else {
            Number++
        }
        $(thumps).prev().attr("src", "https://i.r.worldssl.net/img/td0.png");
        if (Number > 0) {
        ...
        $(thumps).attr("src", "https://i.r.worldssl.net/img/td1.png");
        $(thumps).next().css("opacity", "");
        var Number = $(thumps).prev().text()
        if ($(thumps).next().attr("src") == "https://i.r.worldssl.net/img/tu1.png") {
            Number -= 2
        } else {
            Number -= 1
        }
        $(thumps).next().attr("src", "https://i.r.worldssl.net/img/tu0.png");
        if (Number > 0) {
